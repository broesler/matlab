classdef MATLABGraphicsUpdaterApp < handle
    %
    % Usage:
    %     app.MATLABGraphicsUpdaterApp
    ...
    properties (Constant)
        AppPathBase = {'/MATLABGraphicsUpdater/code'};
        AppClass = 'MATLABGraphicsUpdaterApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = MATLABGraphicsUpdaterApp()
        ...
        function startApp(obj)
            ...
            mlock;
            MATLABGraphicsUpdaterApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'graphicsUpdater')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong graphicsUpdater
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'graphicsUpdater').getString, ...
            ...
            if nargout(@graphicsUpdater) == 0
                eval('graphicsUpdater');
            else
                obj.AppHandle = eval('graphicsUpdater');
            end
